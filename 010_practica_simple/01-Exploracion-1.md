...
![](01-Exploracion-1_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
```
    ...
    ##   0.010   0.060   0.170   0.541   0.480  82.740

``` r
hist(data.vg$Global_Sales)
```

![](01-Exploracion-1_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->

``` r
hist(filter(data.vg,Global_Sales < 5)$Global_Sales)
```

![](01-Exploracion-1_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](01-Exploracion-1_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
Población:
...
```
    ...
    ##       Rank           Name              Platform         Year     
    ##  Min.   :   74   Length:16093       DS     :2118   Min.   :1980  
    ##  1st Qu.: 4290   Class :character   PS2    :2105   1st Qu.:2003  
    ##  Median : 8391   Mode  :character   PS3    :1277   Median :2007  
    ##  Mean   : 8390                      Wii    :1267   Mean   :2006  
    ##  3rd Qu.:12483                      PSP    :1192   3rd Qu.:2010  
    ##  Max.   :16600                      X360   :1189   Max.   :2020  
    ##                                     (Other):6945                 
    ##     Genre            Publisher            NA_Sales         EU_Sales     
    ##  Length:16093       Length:16093       Min.   :0.0000   Min.   :0.0000  
    ##  Class :character   Class :character   1st Qu.:0.0000   1st Qu.:0.0000  
    ##  Mode  :character   Mode  :character   Median :0.0800   Median :0.0200  
    ##                                        Mean   :0.2036   Mean   :0.1153  
    ...
    ##  1st Qu.:0.00000   1st Qu.:0.00000   1st Qu.:0.0600  
    ##  Median :0.00000   Median :0.01000   Median :0.1700  
    ##  Mean   :0.06512   Mean   :0.03814   Mean   :0.4224  
